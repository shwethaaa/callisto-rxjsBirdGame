...
var gamePipes$ = (0, _rxjs.interval)(500).pipe((0, _operators.scan)(function (acc) {
  return (acc.length < 2 ? __spreadArray(__spreadArray([], acc), [createPipes(gameSize)]) : acc).filter(function (c) {
...
var bird$ = (0, _rxjs.merge)((0, _rxjs.interval)(300), (0, _rxjs.fromEvent)(document, "keydown")).pipe((0, _operators.scan)(function (xPos, curr) {
...
(0, _rxjs.combineLatest)(bird$, gamePipes$).pipe((0, _operators.scan)(function (state, _a) {
  var bird = _a[0],
      pipes = _a[1];
  return {
    bird: bird,
  ...
  bird: 0,
  pipes: []
}), (0, _operators.tap)(function (state) {
  return (0, _htmlRenderer.paint)(updateGame(state.bird, state.pipes), state.lives, state.score);
}), (0, _operators.takeWhile)(function (state) {
  return state.lives > 0;
})).subscribe();
},{"rxjs":"../node_modules/rxjs/_esm5/index.js","rxjs/operators":"../node_modules/rxjs/_esm5/operators/index.js","./html-renderer":"html-renderer.ts"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
